...
public class CategoryController {
    ...
    public ResponseEntity<String> getAllCategories(
        ...
        return ResponseEntity.ok("getAllCategories, page =" +page+ "limit = "+ limit);
    }
    @PostMapping("")
    ...
    @PutMapping("/{id}")
    public ResponseEntity<String> putCategory(@PathVariable Long id){
        return ResponseEntity.ok("Put category with id = "+id);
    }
    @DeleteMapping("/{id}")
